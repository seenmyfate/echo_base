= Echo Base
Is a starting point for fast prototyping of Rails 3 apps (demo here: http://echo-base.heroku.com)
...
And you're ready to get spiking - test out the authentication by visiting /auth/twitter (for example)

Check out the docs on web-app-theme at http://github.com/pilu/web-app-theme for examples of how to make use og the layout generators
...
* Heroku version
* Tasks to input initial app config
