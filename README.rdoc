= Echo Base
Is a Rails generator for fast prototyping of Rails 3 apps (demo here: http://echo-base.heroku.com/demo)
...
The generator will optionally:

* configure nosql databases (mongo|redis|couchdb)
* create a heroku app and install lots of add-ons

Generate views with:

    some webapp theme tasks
...
* HTML5/CSS3 layouts (web theme rework)
* Heroku support
* Devise setup
* Full i18n support
