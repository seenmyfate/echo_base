...
class EchoBase < ActiveSupport::TestCase
  test "echo_base skeleton" do
    run_echo_base do
      # Root
  ...
  test "echo_base skeleton with test_unit" do
    run_echo_base do
  ...
  test "echo_base skeleton with rspec" do
    run_echo_base(:rspec) do
  ...
  test "echo_base rakefile can create a gem" do
    run_echo_base do
